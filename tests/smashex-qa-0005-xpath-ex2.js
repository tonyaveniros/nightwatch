...
module.exports = new Test({
	...
	client
		.url("http://www.cheat-sheets.org/saved-copy/Locators_table_1_0_2.pdf")
	},
	"Check for pdf at cheat-sheets.org": function (client) {
	client
		.useXpath().waitForElementPresent("//embed[contains(concat(' ', @src, ' '), ' http://www.cheat-sheets.org/saved-copy/Locators_table_1_0_2.pdf ')]", this.timeout)
